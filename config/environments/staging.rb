MedSafeLabs::Application.configure do
  ...
  config.action_controller.asset_host = "https://medsafelabs-staging.herokuapp.com"
  config.action_mailer.asset_host = "https://medsafelabs-staging.herokuapp.com"
  ...
  config.paperclip_defaults = {
    :storage => :s3,
    :s3_credentials => {
      :bucket => ENV['S3_BUCKET_NAME'], # MedSafeLabsLlcStaging
