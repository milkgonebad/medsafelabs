MedSafeLabs::Application.configure do
  ...
  config.action_controller.asset_host = "https://medsafelabs.herokuapp.com"
  config.action_mailer.asset_host = "https://medsafelabs.herokuapp.com"
  ...
  config.action_mailer.default_url_options = { :host => 'medsafelabs.herokuapp.com' }
  ...
  config.paperclip_defaults = {
    :storage => :s3,
    :s3_credentials => {
      :bucket => ENV['S3_BUCKET_NAME'], # MedSafeLabsLlc
