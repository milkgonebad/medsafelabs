  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved administrator as @administrator" do
        ...
        post :create, {:administrator => { "first_name" => "invalid value" }}, valid_session
        assigns(:administrator).should be_a_new(Administrator)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested administrator" do
        ...
        Administrator.any_instance.should_receive(:update).with({ "first_name" => "MyString" })
        put :update, {:id => administrator.to_param, :administrator => { "first_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the administrator as @administrator" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Administrator.any_instance.stub(:save).and_return(false)
        put :update, {:id => administrator.to_param, :administrator => { "first_name" => "invalid value" }}, valid_session
        assigns(:administrator).should eq(administrator)
      end
